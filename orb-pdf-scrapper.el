...
(defcustom orb-pdf-scrapper-refsection-headings
  ...
  "Determines appearence of sorted Org-mode data generated by Org PDF Scrapper.
...
Takes no effect when `orb-pdf-scrapper-sort-references' is nil."
...
(defcustom orb-pdf-scrapper-sort-references t
  "If this is non-nil, sort the retrieved references into groups.
